 ...
 * profile so the profile stays about "who I am". The profile's gear opens this.
 * Tema and Notificações (toggles) are planned but not shipped yet — they need
 * a theme-override context and push preference management (docs/16 G-08).
 */
export function SettingsScreen() {
  ...
  const groups: { title: string; rows: Row[] }[] = [
    ...
    },
    {
      title: 'AVISOS',
      rows: [
        { icon: 'notifications-outline', label: 'Alertas de vagas', onPress: () => router.push('/alerts') },
      ],
    },
    {
      title: 'AJUDA',
      ...
      <View style={styles.column}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
          ...
          <View style={styles.group}>
            ...
            {/* Diagnóstico de push (dev/suporte). */}
            <Pressable
              accessibilityRole="button"
