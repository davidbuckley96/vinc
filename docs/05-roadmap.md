...
- [x] Perfil editável (nome + bio) + correção de segurança do grant por coluna (D-043→D-044, dúvida #20, 2026-07-09). O campo de gênero foi **removido** por decisão do David (D-044): o nome sinaliza e evita desconforto/discriminação; dúvidas via chat. Escalonamento para `is_admin` fechado; verificado e2e
